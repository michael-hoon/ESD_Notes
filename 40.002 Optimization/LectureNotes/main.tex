...
A constraint is said to be \textbf{active} at a point $\mathbf{x}$ if the constraint is satisfied at equality at that point. \\ 

\noindent A set of linear constraints are linearly independent if their coefficient vectors are linearly independent; else they are linearly dependent. 
...
In Phase I of the Simplex Method, we need to transform the LP into a standard form in Equation \ref{eq:2-standard form}. 
